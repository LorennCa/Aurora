...
public class InventarioController {
	...
	public ResponseEntity<?> consultaReferencias(HttpServletRequest request, @RequestParam(value = "nombre", required = false) String referencia) throws SQLException {
		ResourceResponse resourceResponse = new ResourceResponse();
		OtrasOpciones otrasOpciones = new OtrasOpciones();
		logger.info("Inicia consulta de inventario..."+referencia);
		try {
			...
			otrasOpciones.setInventario(inventarioService.retornaReferencia(referencia));
