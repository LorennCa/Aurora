...
@RestController
@RequestMapping(AppPaths.PROVEEDORES)
...
public class ProveedorController {
	...
	@ApiOperation(value = AppPaths.PROVEEDOR, nickname = "procesos", notes = "Consultar proveedores")
	@RequestMapping(value = AppPaths.PROVEEDOR, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<?> consultaProveedores(HttpServletRequest request, @RequestParam(value = "nombre", required = false) String referencia) throws SQLException {
		ResourceResponse resourceResponse = new ResourceResponse();
		OtrasOpciones otrasOpciones = new OtrasOpciones();
		logger.info("Inicia consulta de proveedores..."+referencia);
		try {
			...
			otrasOpciones.setProveedor(proveedorService.retornaProveedor(referencia));
			...
			logger.info("Finaliza consulta de proveedores...");
		} catch (Exception e) {
