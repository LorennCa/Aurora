...
public interface AppConstants {
	public static final String ODIN_INITIAL_CONFIGURATION_CONTEXT = "/appConf";
	...
	public static final String ODIN_GENERAL_ACCESS_VALIDATE_DATE_CONTEXT = "/validar-fecha-hora";
	public static final String USUARIOS_VALIDAR_PERFILES_HIJOS = "/validar-perfiles-hijos";
	public static final String PASSWORD_DICTIONARY_CONTEXT = "/odin/diccionario";
	...
	public static final String GATEWAY_PATH = "/Aurora/odin";
	...
	public static final String KERBEROS_LOGIN_PATH_GW = "/Aurora/odin/v1/authenticate/login";
	...
	public static final String LETO_PATH = "/Aurora/odin/v1/leto/**";
	public static final String ODIN_RESET_PASS_PATH = "/Aurora/odin/v1/odin/resetPassword";
	...
	public static final String THIS_SERVICE_NAME = "Odin";
	public static interface General {
		...
		public static final String CADENA_USUARIO = "usuarios";
		...
		public static final String VALIDATE_ODIN_GLUU_CONNECTION_UNAUTHORIZED = "HTTP 401 (Unauthorized) status code";

		public static final String ODIN_APPLICATION_CONFIGURATION = "ODIN_APP_CONFIGURATION";
	...
	public static final Integer ODIN_RESET_NOT_FOUND = 100;
	public static final Integer ODIN_RESET_NOT_AUTHORIZED = 101;
	
	/*Codigos de negocio de Usuarios*/
	public static final Integer ODIN_USER_ROL_ENTIDAD_FOUND = 101;
	public static final Integer ODIN_USER_ROL_ENTIDAD_OK = 100;
	public static final Integer ODIN_USER_ROL_ENTIDAD_ONE = 102;
	public static final Integer ODIN_USER_ROL_ENTIDAD_TWO = 103;
