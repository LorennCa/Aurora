...
@RestController
@RequestMapping(AppPaths.Pedidos.PEDIDOS)
...
public class PedidosController {
	...
	@ApiOperation(value = AppPaths.Pedidos.PEDIDOS, nickname = "procesos", notes = "trae los permisos para procesos de pedidos")
	...
	public ResponseEntity<?> get(HttpServletRequest request,
		...
		try {
			...
			otrasOpciones.setPermisos(menuTemplateService.getPermisosByPerfil(perfil, AppPaths.Pedidos.PEDIDO));
