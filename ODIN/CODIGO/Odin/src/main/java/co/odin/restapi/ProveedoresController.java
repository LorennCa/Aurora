...
@RestController
@RequestMapping(AppPaths.Proveedores.PROVEEDORES)
...
public class ProveedoresController {
	...
	@ApiOperation(value = AppPaths.Proveedores.PROVEEDORES, nickname = "procesos", notes = "trae los permisos para procesos de proveedor")
	...
	public ResponseEntity<?> get(HttpServletRequest request,
		...
		try {
			...
			otrasOpciones.setPermisos(menuTemplateService.getPermisosByPerfil(perfil, AppPaths.Proveedores.PROVEEDOR));
