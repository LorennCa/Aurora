...
@RestController
@RequestMapping(AppPaths.Detalles.DETALLES)
...
public class DetallesController {
	...
	@ApiOperation(value = AppPaths.Detalles.DETALLES, nickname = "procesos", notes = "trae los permisos para procesos de carrito")
	...
	public ResponseEntity<?> get(HttpServletRequest request,
		...
		try {
			...
			otrasOpciones.setPermisos(menuTemplateService.getPermisosByPerfil(perfil, AppPaths.Detalles.DETALLE));
