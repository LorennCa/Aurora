...
@RestController
@RequestMapping(AppPaths.Productos.CARRITO)
...
public class CarritoController {
	...
	@ApiOperation(value = AppPaths.Productos.CARRITO, nickname = "procesos", notes = "trae los permisos para procesos de carrito")
