...
@RestController
@RequestMapping(AppPaths.ComprasAdm.COMPRAS)
@Api(value = "Procesos controller")
public class ComprasAdmController {
	/**
	 * variable de log4j para logs de la aplicación
	 */
	private static final Logger logger = LogManager.getLogger(ComprasAdmController.class);
	...
	@ApiOperation(value = AppPaths.ComprasAdm.COMPRAS, nickname = "procesos", notes = "trae los permisos para procesos de proveedor")
	...
	public ResponseEntity<?> get(HttpServletRequest request,
		...
		try {
			...
			System.out.println("Pasa por el controlador de proveedor en cerbero");
			otrasOpciones.setPermisos(menuTemplateService.getPermisosByPerfil(perfil, AppPaths.ComprasAdm.COMPRA));
