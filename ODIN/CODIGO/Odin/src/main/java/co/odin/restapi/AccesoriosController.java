...
@RestController
@RequestMapping(AppPaths.Accesorios.ACCESORIOS)
...
public class AccesoriosController {
	...
	@ApiOperation(value = AppPaths.Accesorios.ACCESORIOS, nickname = "procesos", notes = "trae los permisos para procesos de carrito")
	...
	public ResponseEntity<?> get(HttpServletRequest request,
		...
		try {
			...
			otrasOpciones.setPermisos(menuTemplateService.getPermisosByPerfil(perfil, AppPaths.Accesorios.ACCESORIO));
