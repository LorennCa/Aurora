...
@RestController
@RequestMapping(AppPaths.Productos.PRECOMPRA)
...
public class PrecompraController {
	...
	@ApiOperation(value = AppPaths.Productos.PRECOMPRA, nickname = "procesos", notes = "trae los permisos para procesos de carrito")
	...
	public ResponseEntity<?> get(HttpServletRequest request,
		...
		try {
			...
			otrasOpciones.setPermisos(menuTemplateService.getPermisosByPerfil(perfil, AppPaths.Productos.PRECOMP));
