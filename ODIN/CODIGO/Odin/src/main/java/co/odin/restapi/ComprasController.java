...
@RestController
@RequestMapping(AppPaths.Compras.COMPRAS)
...
public class ComprasController {
	...
	@ApiOperation(value = AppPaths.Compras.COMPRAS, nickname = "procesos", notes = "trae los permisos para procesos de proveedor")
	...
	public ResponseEntity<?> get(HttpServletRequest request,
		...
		try {
			...
			otrasOpciones.setPermisos(menuTemplateService.getPermisosByPerfil(perfil, AppPaths.Compras.COMPRA));
