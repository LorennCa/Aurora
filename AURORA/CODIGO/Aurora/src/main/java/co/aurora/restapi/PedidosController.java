...
@RestController
@RequestMapping(AppPaths.PEDIDOS)
...
public class PedidosController {
	...
	@ApiOperation(value = AppPaths.PEDIDO_CONFIRMADO, nickname = "procesos", notes = "MOstrar inventario")
	@RequestMapping(value = AppPaths.PEDIDO_CONFIRMADO, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
