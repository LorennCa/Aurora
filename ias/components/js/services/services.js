angular.module('ias.services', [])
    ...
    .factory('resourceAccessService', function ($http, configurationServer) {
        ...
        dataAccess.validarAccesoa = function (accesstoken, scope, uri) {
            return $http({
                method: 'GET',
                url: 'http://localhost:8083/ias/v1/inventario/cargado',
                params: {
                    'accesstoken': accesstoken,
                    'scope': scope,
                    'uri': uri
         ...
         dataAccess.validarAccesoo = function (accesstoken, scope, uri) {
            ...
            return $http({
                method: 'GET',
                url: 'http://localhost:8083/ias/v1/referencias/consultar',
                params: {
                    'accesstoken': accesstoken,
                    'scope': scope,
                    'uri': uri
        ...
        */
        ...
        dataAccess.fileUploadServicea = function (scope, accessToken, uri, file, url) {
            ...
            return $http({
                method: 'POST',
                url : 'http://engine.ias.com:8083/ias/v1/inventario/cargar',
                params: parametros,
                headers: {
                    'Content-Type': undefined
                },
