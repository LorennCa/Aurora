...
var ias = angular.module('ias', [
  ...
  'LocalStorageModule',
  'ias.controller',
  'ias.userProfileController',
  'ias.usersController',
  'ias.services',
  'ias.serverConfiguration',
  'ias.userProfileService',
  'ias.inventarioController',
  'ias.ecommerceController'
]);
...
ias.run(function ($rootScope, localStorageService, $state) {
...
ias.config(['KeepaliveProvider', 'IdleProvider', 'localStorageServiceProvider', function (KeepaliveProvider, IdleProvider) {
...
/*Formatear fechas*/
ias.config(['$mdDateLocaleProvider', function ($mdDateLocaleProvider) {
...
ias.config(function ($routeProvider, $locationProvider, $stateProvider, $urlRouterProvider) {
    ...
    .state('menu.productos', {
            ...
            views: {
                'modulosMenu': {
                    templateUrl: 'templates/pages/procesosIAS/inventario.html',
