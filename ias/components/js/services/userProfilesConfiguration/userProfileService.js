angular.module('ias.userProfileService', [])
    //Service main
...
ias.directive('validNumber', function () {
    return {
        require: 'ngModel',
...
/***************************************************************************************************/
ias.directive("regExInput", function () {
    "use strict";
    return {
        restrict: "A",
        require: "?regEx",
...
/*********************************************************************************/
ias.directive('inputMaxlength', function () {
    return {
        require: 'ngModel',
...
ias.filter('percentage', ['$filter', function ($filter) {
 ...
 ******************************************************************/
ias.directive('dateValidate', function () {
    return {
        require: 'ngModel',
...
ias.directive('hourValidate', function () {
    return {
        require: 'ngModel',
 ...
 * un rango de fechas
 *********************************************************/
ias.directive('dateRangeValidate', function () {
    return {
        require: 'ngModel',
        multiElement: true,
        link: function (scope, element, attrs, ngModel) {
 ...
 ******************************************************************/
ias.directive('dateGreater', function () {
    return {
        require: 'ngModel',
 ...
 ******************************************************************/
ias.directive('dvValidate', function (userService) {
    return {
        require: 'ngModel',
 ...
 ******************************************************************/
ias.directive('regexmail', function (globalConstant) {
    return {
        require: 'ngModel',
 ...
 * 4,5,6: Alfanumerico
 ******************************************************************/
ias.directive('regexDoc', function (globalConstant) {
    return {
        require: 'ngModel',
 ...
 ******************************************************************/
ias.directive('noCero', function (globalConstant) {
    return {
        require: 'ngModel',
