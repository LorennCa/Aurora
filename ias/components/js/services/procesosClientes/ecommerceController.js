angular.module('ias.ecommerceController', ['ngIdle', 'ngMaterial'])
    ...
    $scope.inventarioDisp = function(ev){
        ...
        console.log("InventarioDispo");
            resourceAccessService.validarAcceso($scope.userToken, $scope.userScope, '/productos/inventario').then(function onSuccess(data) {
                if (data.status == 200) {
                    //actualizar token 
                    responseOk(data);
