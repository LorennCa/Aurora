angular.module('ias.inventarioController', ['ngIdle', 'ngMaterial'])

    .controller('inventarioController', function ($scope, $route, $state, $mdEditDialog, $mdMedia, $mdToast, $location, $mdSidenav, $mdDialog, $sce, mainService, configurationServer, globalConstant, localStorageService, resourceAccessService, loginService, userService) {
    ...
    $scope.inventarioDisp = function(ev){
            $scope.progressBar = true;
        console.log("InventarioDispo");
            resourceAccessService.validarAcceso($scope.userToken, $scope.userScope, '/carrito/buscar').then(function onSuccess(data) {
                if (data.status == 200) {
                    //actualizar token 
                    responseOk(data);
    ...
    $scope.actualizarProducto = function(producto, ev){
        ...
        $mdDialog.show({
                            controller: userService.DialogController,
                            templateUrl: 'templates/pages/procesosIAS/modificarProducto.html',
                            parent: angular.element(document.body),
                            targetEvent: ev,
                            clickOutsideToClose: false,
                            fullscreen: useFullScreen,
    ...
    $scope.creaReferencia = function(ev){
                    $mdDialog.show({
                            controller: userService.DialogController,
                            templateUrl: 'templates/pages/procesosIAS/crearProducto.html',
                            parent: angular.element(document.body),
                            targetEvent: ev,
                            clickOutsideToClose: false,
                            fullscreen: useFullScreen,
