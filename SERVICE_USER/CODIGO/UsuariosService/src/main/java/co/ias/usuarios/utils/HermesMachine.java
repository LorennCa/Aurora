...
import static co.ias.common.utils.CommonAppConstants.General.CAPITAL_CHARS;
import static co.ias.common.utils.CommonAppConstants.General.NUMBERS;
import static co.ias.common.utils.CommonAppConstants.General.OTP_DIGIT_NUMBER;
import static co.ias.common.utils.CommonAppConstants.General.SMALL_CHARS;
import static co.ias.common.utils.CommonAppConstants.General.SYMBOLS;
...
import co.ias.common.response.RResponse;
...
import co.ias.usuarios.transformers.ContentRequestTransformer;
import co.ias.usuarios.transformers.HeadersRequestTransformer;
import co.ias.usuarios.transformers.URLRequestTransformer;
...
public class HermesMachine {
	...
	private ConfiguracionIAS seeConfig;
	...
	private RResponse createResetEmailTextBody(String userLogin, String email) {
		...
		ResponseEntity<?> seeConfigResponse = consumeRestService(MediaType.TEXT_PLAIN, seeConfigServiceUrl,
				HttpMethod.GET, ConfiguracionIAS.class, null);
		seeConfig = (ConfiguracionIAS) seeConfigResponse.getBody();
	...
	public static String getIPFromRequest(HttpServletRequest request) {
		...
		logger.info(mrc.getMessage("ias.security.autenticacion.request.IP.info", null, null) + ip);
		return ip;
	}
